  ...
  <body>
    ...
    <div class="container">
		...
		<div class="starter-template">
		 ...
		 <?php
			if(!isset($_SESSION['cont2count'])){
				$_SESSION['cont2count'] = -1;
			}
			...
			if(!(isset($_SESSION['username']))){
				...
				echo '<div class="jumbotron">
					...
					<p>You\'ve logged in Successfully!! You\'ve visited this page ' . $_SESSION['cont2count'] . ' many times! </p>
					<p> If you would like to see content1, click <a href="content.php">here!</a></p>
